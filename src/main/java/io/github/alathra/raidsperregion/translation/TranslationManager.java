package io.github.alathra.raidsperregion.translation;
...
import io.github.alathra.raidsperregion.utility.FileUtils;
...
public class TranslationManager implements Reloadable {
     ...
     */
    public TranslationManager(RaidsPerRegion plugin) {
        this.plugin = plugin;
    }
